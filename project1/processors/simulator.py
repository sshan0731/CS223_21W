...
class Simulator:
    ...
    def start(self):
        ...
        print(f"total avg response time = {(self.job_cache.analysis_dict['query_duration'] + self.job_cache.analysis_dict['insert_duration']) / (self.job_cache.analysis_dict['query_counter']+self.job_cache.analysis_dict['transaction_counter'])}")
